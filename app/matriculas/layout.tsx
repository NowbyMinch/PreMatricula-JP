...
export default function RootLayout({children,}: { children: React.ReactNode;} ) {
    ...
    return (
        ...
        <div className={` text-white overflow-hidden max-h-[95%] max-w-[95%] w-[1350px] flex items-center min-h-[800px] h-fit my-4 pb-5 transition-all ease-in-out duration-300 rounded-[25px] bg-[rgba(12,12,14,0.985)] gap-4 z-20 flex-col shadow-2xl`}>
