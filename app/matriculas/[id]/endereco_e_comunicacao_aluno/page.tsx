...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setUpdate((prev) => ({
      ...prev,
      nNumeroEndereco: dados ? dados.aluno.numero : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sComplementoEndereco: dados ? dados.aluno.complemento : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sCidade: dados
        ? dados.aluno.cidade +
          `${dados?.aluno?.uf ? `|${dados?.aluno?.uf}` : ""}`
        : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sBairro: dados ? dados.aluno.bairro : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sTelefone: dados ? dados.aluno.telefone : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sCelular: dados ? dados.aluno.celular : "",
    }));
    ...
    <>
          ...
          <div className="flex flex-col justify-between w-full gap-5">
            ...
            >
              ...
              >
                ...
                <CEP
                  disabled={false}
                  onChange={(value) => {
                    setUpdate((prev) => ({ ...prev, sCEP: value }));
                  }}
                  value={dados?.aluno.cep}
                />
                {/* <motion.input
            ...
            >
                  ...
                  onChange={(e) =>
                    setDados((prev) =>
                      prev
                        ? {
                            ...prev,
                            aluno: { ...prev.aluno, cidade: e.target.value },
                          }
                        : prev
                    )
                  }
                  type="text"
                  defaultValue={dados?.aluno?.cidade}
                  className={` w-full rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[480px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                />
              </motion.div>
              ...
              >
                ...
                <motion.input
                  onChange={(e) => {
                    setUpdate((prev) => ({ ...prev, sBairro: e.target.value }));
                  }}
                  type="text"
            ...
            >
              ...
              >
                ...
                <Celular
                  disabled={false}
                  onChange={(value) => {
                    setUpdate((prev) => ({ ...prev, sTelefone: value }));
                  }}
                  value={dados?.aluno.telefone}
                />
              </motion.div>
              ...
              >
                ...
                <Celular
                  disabled={false}
                  onChange={(value) => {
                    setUpdate((prev) => ({ ...prev, sCelular: value }));
                  }}
                  value={dados?.aluno.celular}
                />
              </motion.div>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <motion.input
                  type="email"
                  onChange={(e) => {
                    setUpdate((prev) => ({ ...prev, sEmail: e.target.value }));
                  }}
              ...
              >
                ...
                >
                  <motion.div
                    className={`w-5 h-5 border-2 ${
                      dados?.aluno?.moraComResponsavel
                ...
                <motion.input
                  disabled
                  type="email"
                  defaultValue={dados ? dados.aluno.moraComResponsavelNome : ""}
                  className={` w-[380px]  rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[480px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                />
              </motion.div>
            </div>
          </div>
      ...
      <div className=" h-full mt-auto">
        <motion.button
          ...
          className="cursor-pointer rounded-[15px] w-fit max-w-full px-14 py-3 bg-gradient-to-r from-yellow-500 to-yellow-400 text-lg text-black font-semibold mx-auto mt-auto "
        >
          Salvar mudanças
        </motion.button>
      </div>
