...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setUpdate((prev) => ({
      ...prev,
      sSexo:
        dados && dados?.aluno?.genero
          ? dados.aluno.genero.toLowerCase()[0].toUpperCase() +
            dados.aluno.genero.toLowerCase().slice(1)
          : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      dDataNascimento: dados ? dados.aluno.dataNascimento : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sCidadeNatal: dados ? dados.aluno.cidadeNatal : "",
    }));
            ...
            >
              ...
              >
                ...
                <Genero
                  onChange={(value) => {
                    setGenero(value);
                    setUpdate((prev) => ({ ...prev, sSexo: value }));
                  }}
                  value={genero}
                />
              </motion.div>
              ...
              >
                ...
                <DataEditar
                  disabled={false}
                  value={dados?.aluno.dataNascimento?.split("/")?.join(" / ")}
                  onChange={(value) => {
              ...
              >
                ...
                <motion.input
                  ...
                  onChange={(e) => {
                    setUpdate((prev) => ({
                      ...prev,
                      sCidadeNatal: e.target.value,
                    }));
                  }}
                  defaultValue={update.sCidadeNatal}
                  className={` w-full rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[480px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                />
              </motion.div>
