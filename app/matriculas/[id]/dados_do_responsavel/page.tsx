          ...
          <div key={0} className="flex flex-col justify-between w-full gap-5">
            ...
            <div className={` w-full max-w-full flex md:flex-row flex-col gap-4`}>
              ...
              className="flex flex-col gap-2 w-full ">
                ...
                <DataEditar disabled={false} value={((dados?.responsaveis[0].dataNascimento)?.split("/"))?.join(" / ")} onChange={(value) => {setUpdate(prev => ({...prev, dDataNascimento: value}))}} />
                ...
                <div className="w-full flex flex-col justify-center items-center gap-4 rounded-[15px] border border-gray-400 min-h-[150px] p-3">
                  ...
                  <div className="flex w-full gap-4">
                    <label className="flex items-center gap-2 ">
                      ...
                      whileTap={{ scale: 0.96}}
                      onChange={() => {}}
                      checked={ dados ? !dados.responsaveis[0]?.pessoaJuridica : false}
            ...
            <div key={1} className="flex flex-col justify-between w-full gap-5">
              ...
              <div className={` w-full max-w-full flex md:flex-row flex-col gap-4`}>
                ...
                className="flex flex-col gap-2 w-full ">
                  ...
                  htmlFor="" 
                  className="origin-left">Gênero</motion.label>
                  <Genero onChange={(value) => {setGenero2(value); setUpdate2(prev => ({...prev, sSexo: value}))}} value={genero2} />
                ...
                className="flex flex-col gap-2 w-full ">
                  ...
                  htmlFor="" 
                  className="origin-left">Data de Nascimento</motion.label>
                  <DataEditar disabled={false} value={((dados?.responsaveis[1].dataNascimento)?.split("/"))?.join(" / ")} onChange={(value) => {setUpdate2(prev => ({...prev, dDataNascimento: value}))}} />
                </motion.div>
