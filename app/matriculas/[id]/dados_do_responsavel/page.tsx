...
export default function Home() {
  ...
  useEffect(() => {
    setUpdate((prev) => ({
      ...prev,
      sNome: dados ? dados?.responsaveis[0]?.nome : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sSexo: dados
        ? dados?.responsaveis[0]?.genero.toLowerCase()[0].toUpperCase() +
          dados?.responsaveis[0]?.genero.toLowerCase().slice(1)
        : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      dDataNascimento: dados ? dados?.responsaveis[0]?.dataNascimento : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      nTipoPessoa: dados?.responsaveis[0]?.pessoaJuridica ? 2 : 1,
    }));
    ...
    setUpdate((prev) => ({
      ...prev,
      sCPFCNPJ: dados ? dados?.responsaveis[0]?.cpf : "",
    }));
    setUpdate((prev) => ({
      ...prev,
      sRG: dados ? dados?.responsaveis[0]?.rg : "",
    }));

    setUpdate2((prev) => ({
      ...prev,
      sNome: dados ? dados?.responsaveis[1]?.nome : "",
    }));
    setUpdate2((prev) => ({
      ...prev,
      sSexo: dados
        ? dados?.responsaveis[1]?.genero.toLowerCase()[0].toUpperCase() +
          dados?.responsaveis[1]?.genero.toLowerCase().slice(1)
        : "",
    }));
    setUpdate2((prev) => ({
      ...prev,
      dDataNascimento: dados ? dados?.responsaveis[1]?.dataNascimento : "",
    }));
    setUpdate2((prev) => ({
      ...prev,
      nTipoPessoa: dados?.responsaveis[1]?.pessoaJuridica ? 2 : 1,
    }));
    ...
    setUpdate2((prev) => ({
      ...prev,
      sCPFCNPJ: dados ? dados?.responsaveis[1]?.cpf : "",
    }));
    setUpdate2((prev) => ({
      ...prev,
      sRG: dados ? dados?.responsaveis[1]?.rg : "",
    }));
            ...
            >
              ...
              >
                ...
                <motion.input
                  ...
                  disabled
                  onChange={(e) => {
                    setUpdate((prev) => ({ ...prev, sNome: e.target.value }));
                  }}
                  defaultValue={update.sNome}
              ...
              >
                ...
                <DataEditar
                  disabled={true}
                  value={dados?.responsaveis[0].dataNascimento
                    ?.split("/")
                    ?.join(" / ")}
                  onChange={(value) => {
                    setUpdate((prev) => ({ ...prev, dDataNascimento: value }));
                  }}
                />
              </motion.div>
            </div>
                  ...
                  <div className="flex w-full gap-4">
                    <label className="flex items-center gap-2 ">
                      <motion.input
                        ...
                        onChange={() => {}}
                        type="radio"
                        className="form-radio   accent-yellow-400 "
                      />
                      Pessoa Física
                    </label>
                    <label className="flex items-center gap-2">
                  ...
                  >
                    <motion.input
                      ...
                      onChange={(e) => {
                        setUpdate((prev) => ({
                          ...prev,
                          sCPFCNPJ: e.target.value,
                        }));
                      }}
                      type="text"
                      defaultValue={update.sCPFCNPJ}
                      className={` w-full rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[420px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                    />
                  </motion.div>
                </div>
                ...
                <div className="w-full flex sm:flex-row flex-col justify-center items-center gap-4 rounded-[15px] border border-gray-400 min-h-[150px] p-3">
                  ...
                  >
                    ...
                    <motion.input
                      disabled
                      onChange={(e) => {
                        setUpdate((prev) => ({ ...prev, sRG: e.target.value }));
                      }}
                      type="text"
                      defaultValue={update.sRG}
                      className={` w-full rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[420px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                    />
                  </motion.div>
                </div>
            ...
            <div key={1} className="flex flex-col justify-between w-full gap-5">
              ...
              >
                ...
                >
                  ...
                  <motion.input
                    ...
                    onChange={(e) => {
                      setUpdate2((prev) => ({
                        ...prev,
                        sNome: e.target.value,
                      }));
                    }}
                    defaultValue={update2.sNome}
                    className={` w-full rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[420px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                  />
                </motion.div>
                ...
                >
                  ...
                  <DataEditar
                    disabled={true}
                    value={dados?.responsaveis[1].dataNascimento
                      ?.split("/")
                      ?.join(" / ")}
                    onChange={(value) => {
                      setUpdate2((prev) => ({
                        ...prev,
                        dDataNascimento: value,
                      }));
                    }}
                  />
                </motion.div>
                    ...
                    <div className="flex w-full gap-4">
                      <label className="flex items-center gap-2 ">
                        <motion.input
                          ...
                          checked={
                            dados
                              ? !dados.responsaveis[1]?.pessoaJuridica
                              : false
                          }
                          onChange={() => {}}
                          type="radio"
                          className="form-radio cursor-none  accent-yellow-400 pointer-events-none"
                        />
                        Pessoa Física
                      </label>
                      <label className="flex items-center gap-2">
                        <motion.input
                          ...
                          onChange={() => {}}
                          type="radio"
                          className="form-radio poicursor-non accent-yellow-400 pointer-events-none"
                        />
                        Pessoa Jurídica
                      </label>
                    </div>
                  ...
                  <div className="w-full flex sm:flex-row flex-col justify-center items-center gap-4 rounded-[15px] border border-gray-400 min-h-[150px] p-3">
                    ...
                    >
                      ...
                      <motion.input
                        ...
                        defaultValue={dados ? dados.responsaveis[1].rg : ""}
                        className={` w-full rounded-[15px] px-4 py-3 border outline-none transition-all ease-in-out duration-300 border-gray-400 max-w-[420px] focus:border-yellow-400 focus:shadow-[0_0_15px_rgba(255,215,0,0.2)] `}
                      />
                    </motion.div>
                  </div>
