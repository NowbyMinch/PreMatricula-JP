...
export default function Home() {
    ...
    try {
      const fetchToken = async () => {
        ...
        if (!preset.completo && PresetValor > AtualValor) {
          ...
          setPessoaJuridica(preset.responsavelPrincipal.pessoaJuridica);
          setParentesco(preset.responsaveis[0].tipoParentesco);
        }
  ...
  return (
    <>
      ...
      >
        <form
          className={`w-full flex flex-col items-center text-white max-w-[90%] min-h-[544px] h-full  `}
