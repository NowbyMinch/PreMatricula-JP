...
export default function Home() {
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>, i: number) => {
      ...
      const handlePaste = (
        ...
        for (
          let i = 0;
          i < pastedText.length && index + i < newCode.length;
          i++
        ) {
    ...
    return (
      <>
        ...
        <div
          className={` h-fit overflow-hidden max-h-[95%] max-w-[95%] w-[600px] transition-all ease-in-out duration-300 rounded-[25px] flex justify-center items-center bg-[rgba(12,12,14,0.985)] gap-4 z-20 flex-col shadow-2xl`}
        >
          <form
          ...
          >
            ...
            <motion.h1
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0 }}
              className="text-[50px] mx-auto my-2 font-medium"
            >
              Registrar
            </motion.h1>
            ...
            <AnimatePresence>
              <div
                className={`w-[480px] max-w-full flex flex-col gap-5 mx-auto `}
              >
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
